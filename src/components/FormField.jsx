      ...
      {label && (
        <div>
          <label
            htmlFor={id}
            className={cn(
              "font-inter text-black text-[13px] flex items-center gap-2",
              typeof hideLabel !== "object" && hideLabel === true
                ? "hidden"
                : hideLabel === false && "block",
              hideLabel?.base === true
                ? "hidden"
                : hideLabel?.base === false && "block",
              hideLabel?.md === true
                ? "md:hidden"
                : hideLabel?.md === false && "md:block",
              hideLabel?.lg === true
                ? "lg:hidden"
                : hideLabel?.lg === false && "lg:block",
              typeof labelFontSize !== "object" &&
                getClassName(labelFontSize, fontSizeLookup),
